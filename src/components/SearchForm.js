          ...
          <form className="" onSubmit={(e) => {
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="flex flex-col">
                ...
                <input onChange={e => changeSearchDate(e.target.value)} type="date" id="date" className="mt-2 block w-full cursor-pointer rounded-md border border-gray-100 bg-gray-100 px-2 py-2 shadow-sm outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" />
              </div>

              <div className="flex flex-col">
                <label htmlFor="category" className="text-sm font-medium text-stone-600">Category</label>

                <select id="category" onChange={(e) => changeSearchCategory(e.target.value)} disabled={!allAvailableCategories?.length} className="mt-2 block w-full cursor-pointer rounded-md border border-gray-100 bg-gray-100 px-2 py-2 shadow-sm outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
